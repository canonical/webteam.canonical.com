...
releases = Blueprint(
    "releases", __name__, template_folder="/templates", static_folder="/static"
)
...
def releases_view():
    return render_template(
        "releases.html", domain_repositories=domain_repositories
    )


@releases.route("/domain-info.json")
def domain_info():
    production_domain = request.args["domain"]
